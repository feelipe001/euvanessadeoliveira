...
var initialSrc = "https://eu.vanessadeoliveeiira.com/" + campaignID + "?format=json";
...
function fixHrefWithClick(
    ...
    document.querySelectorAll('a').forEach(function (el) {
        if (el.href.indexOf("eu.vanessadeoliveeiira.com/click") > -1) {
    ...
    if (!urlParams.get('rtkcid')) {
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                xhrr.open("GET", "https://eu.vanessadeoliveeiira.com/view?clickid=" + rawData.clickid)
                xhrr.send();
            }
        }
        ...
        xhrTrack.open("GET", "https://eu.vanessadeoliveeiira.com/view?clickid=" + rtkClickID)
        xhrTrack.send();
